      ...
      <form onSubmit={onSubmit} className="migrated-039dd51e">
        <div className="migrated-fd720fd5">
          <div className="migrated-20dcf194">
            ...
            <div className="migrated-702ab413">
              ...
              <select
                ...
                onChange={(e) =>
                  setDonorPledge({ ...donorPledge, bloodType: e.target.value })
                }
              >
          ...
          <div className="migrated-5f18923c">
            {["kidney", "liver", "cornea", "heart", "lung", "pancreas"].map(
              (org) => {
                ...
                return (
                  <button
                    ...
                    type="button"
                    onClick={() => {
                      const newOrgans = active
                        ? donorPledge.organs.filter((x) => x !== org)
                        : [...donorPledge.organs, org];
        ...
        <div className="field migrated-cc187a47">
          <input
            ...
            onChange={(e) =>
              setDonorPledge({ ...donorPledge, ageConsent: e.target.checked })
            }
            className="migrated-d2a1a31b"
          />
          <label htmlFor="ageConsent" className="migrated-cd1c6985">
            For this demo, I confirm that I am 18 or older and understand the
            sample pledge shown above.
          </label>
        </div>

        <div className="field">
          <div className="label">
            Digital Signature Document (PDF or Image scan)
          </div>
          <SignatureUploader
            onUploadComplete={(file) =>
              setDonorPledge({ ...donorPledge, signatureName: file.name })
            }
            onClear={() =>
              setDonorPledge({ ...donorPledge, signatureName: "" })
            }
          />
        </div>
        ...
        {anchoringPledge && (
          <div className="card anim-in migrated-32e14a60">
            ...
            <span className="migrated-a54e6f50">
              Preparing the sample pledge record...
            </span>
          </div>
        )}
        ...
        {pledgeAnchor && !anchoringPledge && (
          <div className="card anim-in migrated-bb1140cf">
            ...
            <div className="migrated-83c40d56">
              Demo record reference: {pledgeAnchor.txHash.substring(0, 16)}... |
              Sample record #{pledgeAnchor.blockNumber}
            </div>
          </div>
        )}
        ...
        {pledgeError && !anchoringPledge && (
          <p role="alert" className="migrated-729dd964">
            {pledgeError} The demo record was not saved. Check your connection
            and select “Submit Demo Pledge” to retry.
          </p>
        )}
        ...
        <div className="migrated-888b2c34">
          ...
          <button
            ...
            disabled={
              anchoringPledge ||
              !donorPledge.ageConsent ||
              !donorPledge.signatureName.trim()
            }
          >
            Submit Demo Pledge
          </button>
