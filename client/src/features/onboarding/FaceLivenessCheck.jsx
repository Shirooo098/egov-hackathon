  ...
  return (
    <div className="anim-in migrated-7f597a40">
      ...
      <p className="migrated-dd39b1f9">
        Follow the sample face-check prompts. This prototype demonstrates the
        step; it does not verify your identity or provide a government liveness
        result.
      </p>
      ...
      >
        {livenessStage < 3 && <div className="migrated-6a6769ab" />}
        <svg
          width="90"
          height="90"
          viewBox="0 0 24 24"
