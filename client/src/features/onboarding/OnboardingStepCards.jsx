import './OnboardingStepCards.css';
          ...
          >
            ...
            <div>
              <div className="migrated-6259269e">
                ...
                <span className={`badge badge-${item.badge} migrated-a607aaa0`} >Select</span>
              </div>
  ...
  return (
    <div className="anim-in">
      ...
      <div className="migrated-2f55da8d">
        ...
        <button type="button" className="btn btn-ghost btn-sm migrated-6dac5f26"  onClick={onBack}>Change</button>
      </div>
