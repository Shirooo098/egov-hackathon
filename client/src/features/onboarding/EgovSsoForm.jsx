  ...
  return (
    <div className="anim-in">
      ...
      <div className="migrated-2f55da8d">
        ...
        <button type="button" className="btn btn-ghost btn-sm migrated-6dac5f26"  onClick={onBack}>Back</button>
      </div>
      ...
      <form onSubmit={onSubmit} className="migrated-039dd51e">
        ...
        {ssoError && (
          <div className="migrated-13ec00a5">
            {ssoError}
          </div>
        )}

        <div className="migrated-1d233a92">
          <button className="btn btn-ghost migrated-7e90f870" type="button" onClick={onBack}  disabled={ssoLoading}>
            Back
          </button>
          <button className="btn btn-primary migrated-b3730661" type="submit"  disabled={ssoLoading}>
            {ssoLoading ? <><span className="spinner migrated-13ae4626"  /> Checking demo code…</> : 'Continue with demo code'}
          </button>
        </div>
      </form>
      ...
      {onDemoSignIn && (
        <>
          ...
          >
            ...
            <span className="migrated-9fe3f3ec">(uses a sample identity, skips live eGov and face-check steps)</span>
          </button>
        </>
      )}
    </div>
