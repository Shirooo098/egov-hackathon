...
export default function GovernmentAgreement({
  role = "recipient",
}: {
  ...
  const isComplete =
    ...
    ["contract_signed", "ready_for_transplant"].includes(match.status);
  const currentPartySigned =
    role === "donor"
      ? match.donorSigned || submitted
      : match.recipientSigned || submitted;
  ...
  return (
    <div className="card anim-in government-agreement">
      ...
      <div className="government-agreement__header">
        ...
        <h2 className="government-agreement__title">Donation Agreement</h2>
        <div className="government-agreement__disclaimer">
          Sample workflow copy for this prototype; it is not a government form
          or legal advice.
        </div>
      </div>
        ...
        <div className="government-agreement__callout government-agreement__callout--complete">
          ...
          <div>
            ...
            <div className="government-agreement__callout-copy government-agreement__callout-copy--complete">
              You and your match have both signed. You can now chat with each
              other to plan the day.
            </div>
          </div>
        </div>
      ) : currentPartySigned ? (
      ...
      <div className="government-agreement__section">
        <h3 className="government-agreement__section-title">Who's involved</h3>
        <div className="government-agreement__participant-grid">
          <div>
            <strong>{match.donor.first_name}</strong> is donating{" "}
            <strong className="government-agreement__organ">
              {match.organ}
            </strong>
            .
          </div>
          ...
          <div>
            Hospital:{" "}
            <strong className="government-agreement__hospital">
              {match.hospital.name}
            </strong>
          </div>
          {match.scheduledDate && (
            <div>
              On{" "}
              <strong>
                {match.scheduledDate} at {match.scheduledTime || "10:00 AM"}
              </strong>
              .
            </div>
          )}
      ...
      <details className="government-agreement__terms">
        <summary className="government-agreement__terms-summary">
          ...
          <span className="government-agreement__terms-hint">
            ▾ Tap to read
          </span>
        </summary>
        <ol className="government-agreement__terms-list">
          <li>
            <strong>You're doing this freely.</strong> Nobody is paying you or
            pressuring you. This is your choice.
          </li>
          <li>
            <strong>Clinical care is separate.</strong> A doctor must make any
            clinical decision; this hospital administrator demo does not provide
            medical clearance.
          </li>
          <li>
            <strong>This signature is simulated.</strong> It records your action
            in this prototype and is not a verified identity, legal signature,
            or authorization.
          </li>
        </ol>
      </details>
      ...
      <div className="government-agreement__section government-agreement__signatures">
        <h3 className="government-agreement__section-title">Signatures</h3>
        <div className="government-agreement__signature-grid">
          {/* Donor Signature Box */}
          <div
            className="government-agreement__signature-card"
            style={{
              background: match.donorSigned
                ? "rgba(5, 150, 105, 0.03)"
                : "white",
            }}
          >
            <div className="government-agreement__signature-card-header">
              <span className="government-agreement__signature-name">
                {match.donor.first_name} (Donor)
              </span>
              {match.donorSigned ? (
                <span className="badge badge-success government-agreement__status-badge">
                  ✓ Signed
                </span>
              ) : (
                <span className="badge badge-muted government-agreement__status-badge">
                  Not yet
                </span>
              )}
            </div>
            {match.donorSigned ? (
              <div className="government-agreement__signed-record">
                ...
                <div className="government-agreement__signed-copy">
                  <div className="government-agreement__signed-title">
                    Signed
                  </div>
                  <div className="government-agreement__signed-detail">
                    Recorded in demo
                  </div>
                </div>
              </div>
              ...
              <SignatureUploader
                onUploadComplete={handleSignatureComplete}
          ...
          <div
            className="government-agreement__signature-card"
            style={{
              background: match.recipientSigned
                ? "rgba(5, 150, 105, 0.03)"
                : "white",
            }}
          >
            <div className="government-agreement__signature-card-header">
              <span className="government-agreement__signature-name">
                {match.recipient.first_name} (Recipient)
              </span>
              {match.recipientSigned ? (
                <span className="badge badge-success government-agreement__status-badge">
                  ✓ Signed
      ...
      {currentPartySigned && (
        <div className="government-agreement__recorded-notice">
          ✓ Your demo agreement action was recorded. It is not a legal
          declaration or clinical authorization.
        </div>
      )}
    </div>
  );
