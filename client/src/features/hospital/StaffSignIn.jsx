      ...
      >
        <div className="container">
          ...
          >
            ...
            <p>
              This is a presentation-only prototype. It does not authenticate
              employment, institutional authority, or production access.
            </p>
            <button
              type="button"
              className="btn btn-primary btn-lg"
              aria-label="Continue as PGH demo staff"
              onClick={continueAsDemoStaff}
            >
