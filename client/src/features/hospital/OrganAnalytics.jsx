    ...
    <div className="anim-up organ-analytics__1-1">
      ...
      <div className="grid-auto">
        ...
        <div className="card card-sm organ-analytics__14-1">
          ...
          <span className="organ-analytics__17-1">Simulated agreement records</span>
        </div>
      </div>
            ...
            {ORGAN_DATA.map((o) => (
              <div className="organ-analytics__20-1" key={o.name}>
                <div className="organ-analytics__21-1">
                  <span>{o.name}</span>
                  <span className="organ-analytics__2-2">{o.pledges} Pledges ({Math.round(o.pledges / totalPledges * 100)}%)</span>
                </div>
                {/* Custom compatibility track indicator */}
                <div className="compat-track organ-analytics__3-2">
                  <div 
                    className="compat-fill organ-analytics__1-3" style={{width: `${o.pledges / 92 * 100}%`, background: o.color}}
                  />
                </div>
              </div>
            ))}
            ...
            {role === 'recipient' && (
              <div className="organ-analytics__24-1">
                <div className="organ-analytics__25-1">
                  <div className="organ-analytics__5-2">Average Queue Duration</div>
                  <div className="organ-analytics__26-1">18.4 Days</div>
                  <p className="organ-analytics__27-1">Time elapsed from initial request verification to clinical schedule proposal.</p>
                </div>
                <div className="organ-analytics__28-1">
                  <div className="organ-analytics__6-2">Sample procedure rate</div>
                  <div className="organ-analytics__29-1">94.2%</div>
                  <p className="organ-analytics__30-1">Percentage of matches completing successful clinical procedures.</p>
                </div>
              </div>
            )}
            ...
            {role === 'donor' && (
              <div className="organ-analytics__31-1">
                <div className="organ-analytics__32-1">
                  <div className="organ-analytics__7-2">Illustrative pledge capacity</div>
                  <div className="organ-analytics__33-1">192 Citizens</div>
                  <p className="organ-analytics__34-1">Calculated capacity from cumulative active pledges across the region.</p>
                </div>
                <div className="organ-analytics__35-1">
                  <div className="organ-analytics__8-2">Digital signature demo</div>
                  <div className="organ-analytics__36-1">Simulated</div>
                  <p className="organ-analytics__37-1">Signature actions are represented in this prototype and are not verified on a national registry.</p>
                </div>
              </div>
            )}
            ...
            {role === 'hospital' && (
              <div className="organ-analytics__38-1">
                <div className="organ-analytics__39-1">
                  <div className="organ-analytics__9-2">Schedule Proposal Accuracy</div>
                  <div className="organ-analytics__40-1">99.2%</div>
                  <p className="organ-analytics__41-1">Percentage of schedule proposals accepted by hospitals, donors, and recipients.</p>
                </div>
                <div className="organ-analytics__42-1">
                  <div className="organ-analytics__10-2">Sample workflow records</div>
                  <div className="organ-analytics__43-1">4,821 demo events</div>
                  <p className="organ-analytics__44-1">Illustrative records in this prototype; no on-chain clinical transactions are claimed.</p>
                </div>
              </div>
            )}
          </div>
