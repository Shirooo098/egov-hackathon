...
type Props = { firstName?: string; lastName?: string; tier?: string };
export default function VerifiedPill({
  ...
  const displayName =
    [firstName, lastName].filter(Boolean).join(" ") || "Citizen";
  return (
    <div className="verified-pill">
      <div aria-hidden="true" className="verified-pill-avatar">
        {initial}
      </div>
      <span className="verified-pill-name">{displayName}</span>
      <span
