...
export default function DonorDashboard() {
  ...
  const [isBlood,   setIsBlood]   = useState(true);
  const [organs,    setOrgans]    = useState(['kidney','cornea']);
    ...
    <div style={{ minHeight:'100vh', background:'var(--background)' }}>
      ...
      <section className="hero">
        ...
        <div className="container" style={{ position:'relative' }}>
          ...
          <p className="hero-p anim-up-d2">Manage your blood and organ donation pledge. Every donation is verified by PhilSys and recorded securely on the blockchain.</p>
        ...
        <div className="container">
          ...
          {tab === 'profile' && (
            <div style={{ maxWidth:680, margin:'0 auto', display:'flex', flexDirection:'column', gap:18 }}>
                ...
                <div style={{ display:'flex', alignItems:'center', gap:18, marginBottom:24 }}>
                  ...
                  <div>
                    ...
                    <div style={{ display:'flex',gap:8,marginTop:6 }}>
                      <span className="badge badge-verified">PhilSys âœ“ Tier I</span>
                      <span className={`badge ${avail?'badge-success':'badge-muted'}`}>{avail?'â— Available':'â—‹ Unavailable'}</span>
                    </div>
                  </div>
              ...
              {/* Organ pledges â€” like API catalog cards */}
              <div className="card anim-up-d1">
                ...
                <div style={{ padding:'12px 16px', background:'var(--primary-10)', border:'1px solid rgba(0,56,168,0.12)', borderRadius:'var(--r-md)', borderLeft:'3px solid var(--primary)', fontSize:13, color:'var(--primary)', lineHeight:1.65 }}>
                  Organ pledges are secured with PhilSys eVerify. Legal consent will be anchored to the Hyperledger Besu blockchain.
                </div>
              </div>
          ...
          {tab === 'matches' && (
            <div style={{ maxWidth:680, margin:'0 auto' }}>
              <div className="card anim-up">
                ...
                <div style={{ display:'flex', alignItems:'center', gap:16, padding:16, background:'var(--background-alt)', borderRadius:'var(--r-lg)', border:'1px solid var(--border)' }}>
                  <div className="blood-pill blood-pill-blood">A+</div>
                  <div style={{ flex:1 }}>
                    <div style={{ fontWeight:700, fontSize:15 }}>Ana Reyes</div>
                    <div style={{ fontSize:12, color:'var(--foreground-muted)', marginTop:2 }}>Makati City Â· Blood request</div>
                  </div>
                  ...
                  <button className="btn btn-primary btn-sm" onClick={() => setTab('chat')}>Chat â†’</button>
                </div>
              </div>
            </div>
          )}
          ...
          {/* CHAT */}
          {tab === 'chat' && <div style={{ maxWidth:640, margin:'0 auto' }}><ChatBox currentRole="donor" /></div>}
