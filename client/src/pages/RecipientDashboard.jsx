...
export default function RecipientDashboard({ onboardingHealth }) {
  ...
  const saveProfile = (e) => {
    e.preventDefault();
    const res = updateMatchFromProfile("recipient", {
      bloodTypeNeeded,
      organNeeded,
      urgencyLevel,
    });
    if (res.success) {
      ...
      warning(res.error || "Failed to update prefereSnces", {
        title: "Sync Warning",
        duration: 4000,
      });
    }
              ...
              <div className="card anim-up recipient-profile-card">
                ...
                <form onSubmit={saveProfile} className="recipient-profile-form">
                  ...
                  <div className="recipient-notice">
                    ℹ️ Changing your profile refreshes the compatibility
                    estimate shown in this prototype. It does not query a live
                    donor registry.
                  </div>
              ...
              {isScheduleUnlocked ? (
                <>
                  ...
                  <CalendarScheduleView
                    ...
                    onBookSlot={(slot) => {
                      toast.success(
                        "Clinical consultation procedure slot booked successfully.",
